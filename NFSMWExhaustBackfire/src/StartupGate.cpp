...
constexpr wchar_t kDpapiDescription[] =
    L"NFSMW Exhaust Backfire device binding";
constexpr char kDpapiEntropy[] =
    "NFSMW.NFSMWExhaustBackfire.DeviceBinding.v1";

constexpr char kBindingJsonPrefix[] =
    "{\r\n"
    "  \"schema\": 1,\r\n"
    "  \"product\": \"NFSMWExhaustBackfire\",\r\n"
...
bool ComputeHardwareId(const DeviceComponents& components, char output[65],
    ...
    constexpr char domain[] = "NFSMWExhaustBackfire.DeviceBinding.v1";
